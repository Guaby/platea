  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center">
      ...
      <div className='absolute'>
        <span className='video-layer absolute top-0 left-0 w-full h-full bg-black opacity-20'></span>
      ...
      <main className='flex relative w-full h-screen lg:w-auto lg:h-auto'>
       <div className='px-2 lg:px-16 py-8 pt-0 w-full lg:w-auto left-0 bottom-0 max-w-full lg:max-w-lg flex flex-col items-center absolute lg:relative'>
          <h1 className='text-4xl font-bold text-white mb-32 px-2'>Explora todo lo que puedes hacer en Puerto Rico.</h1>

         {/* ==== Steps ==== */}
         <div className='w-11/12 px-5 py-2 overflow-hidden bg-slate-100 rounded-2xl fixed bottom-4' ref={el => (stepsList = el)}>
          ...
          <div className={'w-full overflow-hidden ' + (state.isActive1 ? 'active' : '')}>
              <a onClick={nextSlide} href='#' className='text-white'>
                <div className={'relative p-4 pl-7 flex justify-between items-center my-4'}>
                  <span className='absolute bg-white left-0 top-0 right-0 bottom-0 w-full rounded-full'></span>
                  <p className='relative text-black'>¿Qué quiero hacer?</p>
                  <span className='bg-slate-100 relative w-10 h-10 rounded-full flex items-center justify-center'>
          ...
          {/* Step 2 */}
          <div className={'w-full text-left overflow-hidden h-0 ' + (state.isActive2 ? 'active' : '')}>
              <h2 className='text-lg font-bold mb-4 pt-4'>¿Qué hacer?</h2>
              <div className='overflow-hidden'>
                <ul className='ttd mb-3 border-solid border border-black-400 rounded-md px-8 py-6 max-h-80 overflow-scroll'>
                  <li>Restaurantes</li>
                  <li>Hospedaje</li>
                  <li>Playas</li>
              ...
              <div className='w-11/12 mx-auto'>
                <a onClick={nextSlide} href='#' className='text-black'>
                  <div className='relative p-4 pl-7 py-6 flex justify-center items-center my-4'>
                    <span className='absolute left-0 top-0 right-0 bottom-0 w-full rounded-full border-solid border-2 border-black'></span>
          ...
          <div className={'w-full text-left overflow-hidden h-0 ' + (state.isActive3 ? 'active' : '')}>
              <h2 className='text-lg font-bold mb-4 pt-4'>¿Dónde?</h2>
              <div className='overflow-hidden'>
